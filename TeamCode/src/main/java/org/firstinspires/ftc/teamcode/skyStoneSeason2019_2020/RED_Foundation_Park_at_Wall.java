...
public class RED_Foundation_Park_at_Wall extends LinearOpMode {
...
// lift Arm Up and midShift left
     ...
     while(midShift.isBusy() && opModeIsActive()){
      ...
      while(midShift.isBusy() && colorSensorLT.red() < 30 && opModeIsActive()){
          telemetry.addData("color red:", colorSensorRT.red());
          telemetry.update();
  }
  midShift.setPower(0);
 midShift.setMode(DcMotor.RunMode.STOP_AND_RESET_ENCODER);
