//BLUE_Foundation_Park_at_Skybridge 1/29/2020
...
public class BLUE_Foundation_Park_at_Skybridge extends LinearOpMode {
...
// lift Arm Up and midShift left
      ...
      midShift.setTargetPosition(1300); 
...
// Tunn 90 Backside to skybridge
    ...
    backRight.setPower(.30);
     ...
     backLeft.setTargetPosition(-520);
     backRight.setTargetPosition(520);
     ...
     backLeft.setMode(DcMotor.RunMode.RUN_TO_POSITION);
      ...
      backLeft.setMode(DcMotor.RunMode.STOP_AND_RESET_ENCODER);
        ...
        while(opModeIsActive() && colorSensorLT.blue() < 35 && colorSensorRT.blue() < 35) {    
